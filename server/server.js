...
app.prepare().then(async () => {
  ...
  router.get("/orders", async (ctx) => {
    ...
    const urlOrders = 'https://' + ctx.query.shop + '/admin/api/2021-07/orders.json?status=any'
    const urlCustomers = 'https://' + ctx.query.shop + '/admin/api/2021-07/customers.json?since_id=1'
